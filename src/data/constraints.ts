...
export const FIGHTER_BLOCK_DAMAGE_MULTIPLIER = 0.65625;
export const FIGHTER_SPLASH_RADIUS = 0;
export const FIGHTER_ARMOR_PIERCE = 0;
export const FIGHTER_ANTI_DRONE_MULTIPLIER = 2.25;
...
export const BOMBER_BLOCK_DAMAGE_MULTIPLIER = 1.65;
export const BOMBER_SPLASH_RADIUS = 1.6;
export const BOMBER_ARMOR_PIERCE = 0.2;
export const BOMBER_ANTI_DRONE_MULTIPLIER = 0.15;
